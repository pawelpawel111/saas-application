...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var RoutesFirstOperator = (function () {
    ...
    var RoutesFirstSubscriber = (function (_super) {
        __extends(RoutesFirstSubscriber, _super);
    ...
    function switchMap(project, resultSelector) {
        ...
        return function (source) { return source.lift(new RoutesMapOperator(project)); };
    }
    var RoutesMapOperator = (function () {
        function RoutesMapOperator(project) {
            this.project = project;
        }
        RoutesMapOperator.prototype.call = function (subscriber, source) {
            return source.subscribe(new RoutesMapSubscriber(subscriber, this.project));
        };
        return RoutesMapOperator;
    }());
    var RoutesMapSubscriber = (function (_super) {
        __extends(RoutesMapSubscriber, _super);
        function RoutesMapSubscriber(destination, project) {
            var _this = _super.call(this, destination) || this;
            _this.project = project;
            _this.index = 0;
            return _this;
        }
        RoutesMapSubscriber.prototype._next = function (value) {
            var result;
            var index = this.index++;
            try {
                result = this.project(value, index);
        ...
        RoutesMapSubscriber.prototype._innerSub = function (result) {
        ...
        RoutesMapSubscriber.prototype._complete = function () {
            var innerSubscription = this.innerSubscription;
            if (!innerSubscription || innerSubscription.closed) {
                _super.prototype._complete.call(this);
            }
        ...
        RoutesMapSubscriber.prototype._unsubscribe = function () {
            this.innerSubscription = undefined;
        };
        RoutesMapSubscriber.prototype.notifyComplete = function () {
            this.innerSubscription = undefined;
            if (this.isStopped) {
                _super.prototype._complete.call(this);
            }
        };
        RoutesMapSubscriber.prototype.notifyNext = function (innerValue) {
            this.destination.next(innerValue);
        };
        return RoutesMapSubscriber;
    }(SimpleOuterSubscriber));
