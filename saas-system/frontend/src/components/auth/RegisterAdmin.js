...
function RegisterAdmin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:3000/api/register/admin', { email, password });
    ...
    return (
        <div>
            ...
            <p>Wypełnij poniższy formularz, aby utworzyć konto administratora.</p>
